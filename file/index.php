...
$auth_users = array(
    'admin' => '75d7210b88ca2b7e510c6d218a67a4a2', //admin
    'user' => '75d7210b88ca2b7e510c6d218a67a4a2', //12345
);
...
if ($use_auth) {
    if (isset($_SESSION['logged'], $auth_users[$_SESSION['logged']])) {
        ...
        // Logging In
        //sleep(1);
        if (isset($auth_users[$_POST['fm_usr']]) && md5(md5($_POST['fm_pwd'])) === $auth_users[$_POST['fm_usr']]) {
