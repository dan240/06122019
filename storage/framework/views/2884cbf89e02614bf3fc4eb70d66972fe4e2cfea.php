                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="left" style="font-size: 14px; font-family: Helvetica, Arial, sans-serif; color: #333333; padding-top: 30px;" class="padding"> <p>Hi <?php echo e(@$userData['name']); ?>,</p></td>
                                        </tr>
                                          <tr>
...
<?php /**PATH /home/admin/web/londcap-app.com/public_html/resources/views/frontend/email/forget-password.blade.php ENDPATH**/ ?>