...
<?php $__env->startSection('content'); ?>
  ...
  crossorigin="anonymous"></script>
        ...
        <div class="container">
            <div class="row centered-container clearfix">
                <?php echo e(Form::open(["method" => "post","class" => "login-container"])); ?>
                    ...
                    <p> Hi, <?php echo e(Session::get('fname')); ?> <?php echo e(Session::get('lname')); ?>. To access our VC-backed deal flow, simply verify your <?php if(Session::get('utype')==1){ echo "company"; } elseif(Session::get('utype')==2){ echo "investor"; } ?> status:</p>
    ...
    <script>
        ...
        $("#second").on('click',function(e){
            ...
            if($(".login-container").valid()){
                $.ajax({
                    method:"POST",
                    url:"<?php echo e(url('User/successSignup')); ?>",
                    data:$(".login-container").serialize(),
                    success:function(data){
                        if(data.msg=='Success'){
                            location.href="<?php echo e(url('User/emailnotverified')); ?>";
                        }
                        
                        // //debugger;
                        // if(data.msg=='Success' && data.utype == 1){
                        //     //debugger;
                        //     location.href="<?php echo e(url('User/addcompanyProfile')); ?>";
                        // }
                        // else if(data.msg=='Success' && data.utype == 2){
                        //     //debugger;
                        //     location.href="<?php echo e(url('User/addinvestorProfile')); ?>";
                        // }
    ...
    function BindControls(){
        $.ajax({
            method:"POST",
            url:"<?php echo e(url('User/findCityList')); ?>",
...
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/londcap-app.com/public_html/resources/views/frontend/confirmSignup.blade.php ENDPATH**/ ?>