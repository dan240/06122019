    <header class="app-header navbar">
      <button class="navbar-toggler sidebar-toggler d-lg-none mr-auto" type="button" data-toggle="sidebar-show">
       ...
       <a class="navbar-brand" id="home" href="<?php echo e(url('Admin/dashboard')); ?>"><img src="<?php echo e(asset('images/Logo%20LondCap.png')); ?>" /></a>
      ...
      <ul class="nav navbar-nav d-md-down-none">
        ...
        <li class="nav-item px-3">
          <a class="nav-link" href="<?php echo e(url('Admin/User')); ?>">Users</a>
        </li> -->
        <!-- <li class="nav-item px-3">
      ...
      <ul class="nav navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown admin-data">
         ...
         <img class="img-avatar" src="<?php echo e(asset('admin/img/avatars/6.jpg')); ?>" alt="admin@bootstrapmaster.com">
          </a>
...
</script><?php /**PATH /home/admin/web/londcap-app.com/public_html/resources/views/backend/include/header.blade.php ENDPATH**/ ?>