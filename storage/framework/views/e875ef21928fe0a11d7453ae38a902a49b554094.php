                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="left" style="font-size: 14px; font-family: Helvetica, Arial, sans-serif; color: #333333; padding-top: 30px;" class="padding"> <p>Hi <?php echo e($reciver['firstname']); ?> <?php echo e($reciver['lastname']); ?>,, </p></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="left" style="padding: 0px 0 0 0; font-size: 14px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding">
                                            <p>You have a message form <?php echo e($sender['firstname']); ?> <?php echo e($sender['lastname']); ?>,</p>
                                            <p>"<strong><?php print_r($message_contant); ?></strong>"</p>
                                            <p>
                                                <a href="<?php echo e(url('/')); ?>" title="Login and reply" class="btn btn-primary btn-block">Login and Reply</a>
                                            </p>
                                        </tr>
                                    </table>
                                </td>
...
<?php /**PATH /home/admin/web/londcap-app.com/public_html/resources/views/frontend/email/message.blade.php ENDPATH**/ ?>