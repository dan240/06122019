...
#country_chosen > .chosen-single,#city_chosen > .chosen-single{ margin-top: 16px!important; }
        ...
        <?php echo e(Form::open(['class'=>'editInvestors','method'=>'post','enctype' => 'multipart/form-data','novalidate' => ''])); ?>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="fb-profile-block">
                        ...
                        <div class="profile-name">
                            ...
                            <h4><?php echo e(@$data['firmName']); ?></h4>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item "><a href="javascript:;" onclick="userInvestorIntrestedIn('<?php echo e($id); ?>')">Express Interested (Follower) <?php echo e(app('App\Http\Controllers\UserController')->MeExpressedIn()); ?></a></li>
                            <li class="breadcrumb-item "><a href="javascript:;" onclick="userInvestorExpressed('<?php echo e($id); ?>')">Interested In (Following) <?php echo e(app('App\Http\Controllers\UserController')->MeInterestedIn()); ?></a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group inner-label-holder"> <small class="label smallLabel" for="input">First Name </small>
                                        ...
                                        <input type="text" class="form-control" value="<?php echo e(@$data['user']['firstname']); ?>" name="firstname" >
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group inner-label-holder"> <small class="label smallLabel" for="input">Last Name</small>

                                        <input type="text" class="form-control" value="<?php echo e(@$data['user']['lastname']); ?>" name="lastname" >
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group inner-label-holder"> <small class="label smallLabel" for="input">Job Title</small>

                                        <input type="text" class="form-control" value="<?php echo e(@$data['jobTitle']); ?>" name="jobTitle" >
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group inner-label-holder"> <small class="label smallLabel" for="input">Invesor Firm Name</small>

                                        <input type="text" class="form-control" value="<?php echo e(@$data['firmName']); ?>" name="firmName">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    ...
                                    <div class="form-group inner-label-holder"> <small class="label smallLabel" for="input">Phone Number</small>
                                        ...
                                        <input type="text" id="phoneno" class="form-control" value="<?php echo e(@$data['phoneno']); ?>" name="phoneno">
                                    </div>
                                </div>
                                 <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group inner-label-holder"> <small class="label smallLabel" for="input">Investor firm url</small>
                                        ...
                                        <input type="text" class="form-control" value="<?php echo e(@$data['investorfirmUrl']); ?>" name="investorfirmUrl">
                                    </div>
                                </div>
                                   <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group inner-label-holder"> <small class="label smallLabel" for="input">Investor firm Fundraising URL</small>

                                        <input type="text" class="form-control" value="<?php echo e(@$data['fundraisUrl']); ?>" name="fundraisUrl">
                                    </div>
                                </div>
                                   <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group inner-label-holder"> <small class="label smallLabel" for="input">Investor Firm Video</small>

                                        <input type="text" class="form-control" value="<?php echo e(@$data['investorFirmvideo']); ?>" name="investorFirmvideo">
                                    </div>
                                </div>
                                   <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group inner-label-holder"> <small class="label smallLabel" for="input">Slideshare URL</small>

                                        <input type="email" class="form-control" value="<?php echo e(@$data['slideshareUrl']); ?>" name="slideshareUrl">
                                    </div>
                                </div>
                        ...
                        <div class="card-content investorProfileActive">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    ...
                                    <h6><input type="text" class="form-control" id="textlimit" value="<?php echo e(@$data['firmTagline']); ?>" name="firmTagline"></h6>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <p>Investor Firm Profile</p>
                                        <div class="form-group inner-label-holder textarea">
                                        <textarea class="form-control" name="profileText" rows="4"><?php echo e(@$data['profileText']); ?></textarea>
                                    </div>
                                </div>
                              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                  <p>Short Investor Biography</p>
                                    <div class="form-group inner-label-holder textarea">
                                        <textarea class="form-control" name="bioData" rows="4"><?php echo e(@$data['bioData']); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-group inner-label-holder multiselect"> <small class="label smallLabel" for="input">Investor type</small>
                                        <select name="investorType[]" class="chosen-select" multiple>
                                            ...
                                            <?php $__currentLoopData = $investor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $in): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($in['id']); ?>" <?php if(in_array($in['id'], $invtrType)) echo "selected"; ?>><?php echo e($in['typeInvestor']); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                                 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-group inner-label-holder multiselect">
                                        ...
                                        <select name="investmentType[]" class="chosen-select" multiple>
                                            ...
                                            <?php $__currentLoopData = $investment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $in): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($in['id']); ?>" <?php if(in_array($in['id'], $invType)){echo "selected";}?>><?php echo e($in['typeInvestment']); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                                 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-group inner-label-holder multiselect">
                                        ...
                                        <select class="chosen-select" multiple placeholder="Select Sector Focus" tabindex="4" name="sectorFocus[]" id="multiSector">
                                                ...
                                                ?>
                                                        <option value="<?php echo e($se['id']); ?>" <?php if(in_array($se['id'], $sec)){echo "selected";}?>><?php echo e($se['sectorName']); ?></option>
                                                <?php  } ?>
                                        </select> 
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group inner-label-holder multiselect">
                                        ...
                                        <select class="chosen-select" multiple placeholder="Select Industry Focus" tabindex="4" name="industryFocus[]">
                                                ...
                                                <?php  $ind = explode(",",$data['industryFocus']);
                                                        ...
                                                        <option value="<?php echo e($in['id']); ?>" <?php if(in_array($in['id'], $ind)){ echo "selected"; }?>><?php echo e($in['industryName']); ?></option>
                                                <?php }  ?>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group inner-label-holder multiselect">
                                        ...
                                        <select class="chosen-select" multiple placeholder="Select Region Focus" tabindex="4" name="regionFocus[]">
                                            ...
                                            <?php $in = explode(",",@$data['regionFocus']);
                                                    ...
                                                    <option value="<?php echo e($re['id']); ?>" <?php if(in_array($re['id'] , $in)){ echo "selected"; } ?>><?php echo e($re['regionName']); ?></option>
                                            <?php  } ?>
                                        </select>
                                    </div>
                                </div>
                                        ...
                                        <select class="chosen-select" multiple placeholder="Select Country Focus" tabindex="4" name="countryFocus[]">
                                                ...
                                                <?php  $cont = explode(",",$data['countryFocus']);
                                                    foreach ($country as $co) { ?>
                                                        <option value="<?php echo e($co['id']); ?>" <?php if(in_array($co['id'] , $cont)){ echo "selected"; } ?>><?php echo e($co["country_name"]); ?></option>
                                                <?php  } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-group inner-label-holder"> <small class="label smallLabel" for="input">Assets Under Management $</small>
                                        ...
                                        <input type="text" class="form-control" name="assetUndermgmt" id="assetUndermgmt" value="<?php echo e(@$data['assetUndermgmt']); ?>">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-group inner-label-holder"> <small class="label smallLabel" for="input">Investment Range From $</small>
                                        ...
                                        <input type="text" class="form-control" id="investmentRangefrm" name="investmentRangefrm" value="<?php echo e($data['investmentRangefrm']); ?>">
                                    ...
                                    <div class="form-group inner-label-holder"> <small class="label smallLabel" for="input">Investment Range to $</small>
                                        ...
                                        <input type="text" class="form-control" name="investmentRangeto" id="investmentRangeto" value="<?php echo e($data['investmentRangeto']); ?>">
                        ...
                        <div class="card-content social makeactivesocial">
                            ...
                            <div class="row">
                              ...
                              <div class="input-group form-group inner-label-holder">
                                  ...
                                  <small class="label smallLabel" for="input">LinkedIn URL</small><input type="text" class="form-control" name="linkedinUrl" aria-label="Username" aria-describedby="basic-addon1" value="<?php echo e(@$data['linkedinUrl']); ?>">
                                </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <div class="input-group form-group inner-label-holder">
                                  ...
                                  <small class="label smallLabel" for="input">Facebook URL</small><input type="text" class="form-control" name="fbUrl" aria-label="Username" aria-describedby="basic-addon1" value="<?php echo e(@$data['fbUrl']); ?>">
                                </div>
                                </div>
                                     <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <div class="input-group form-group inner-label-holder">
                                  ...
                                  <small class="label smallLabel" for="input">Twitter URL</small><input type="text" class="form-control" name="twitterUrl" aria-label="Username" aria-describedby="basic-addon1" value="<?php echo e(@$data['twitterUrl']); ?>">
                                </div>
                                </div>
...
<script>
        $(document).ready(function(){
            ...
            $("#save").on('click',function(e){
                ...
                if($(".editInvestors").valid()){
                    ...
                    $.ajax({
                        method:"POST",
                        url:"<?php echo e(url('User/saveInvestorProfile')); ?>",
                        data:formData,
                        cache: false,
                        processData: false, 
                        contentType: false,
            ...
            $("#publish").on('click',function(e){
                ...
                $.ajax({
                    method:"POST",
                    url:"<?php echo e(url('User/investorPublishData')); ?>",
        ...
        function viewInvestorProfile(id)
            {
                window.location.href="<?php echo e(url('User/viewiProfile/')); ?>/"+id;
            }
    </script>
    <script>
            $(document).ready(function() {
            ...
            $('input#investmentRangeto').keyup(function(e) {
              ...
              $(this).val(function(index, value) {
               ...
               function userInvestorExpressed(id)
                ...
                {
                    window.location.href="<?php echo e(url('User/userInvestorIntrestedIn/')); ?>/"+id;
                }
            </script>
...
<?php echo $__env->make('layouts.investor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/londcap-app.com/public_html/resources/views/frontend/investors-profile-edit.blade.php ENDPATH**/ ?>