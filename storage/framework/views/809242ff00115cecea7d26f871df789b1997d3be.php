...
.details-div{
                         ...
                         <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group inner-label-holder"> <small class="label" for="input">First Name </small>
                                        <input type="text" class="form-control" name="firstname" value="<?php echo e(@$data['user']['firstname']); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group inner-label-holder"> <small class="label" for="input">Last Name</small>
                                        <input type="text" class="form-control" name="lastname" value="<?php echo e(@$data['user']['lastname']); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group inner-label-holder"> <small class="label" for="input">Job Title</small>
                                        <input type="text" class="form-control" name="jobTitle" value="<?php echo e(@$data['jobTitle']); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group inner-label-holder"> <small class="label" for="input">Invesor Firm Name</small>
                                        <input type="text" class="form-control" name="firmName" value="<?php echo e(@$data['firmName']); ?>" readonly>
                                    </div>
                                </div>
                                <?php if($see_contacts=='yes'){?>
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group inner-label-holder"> <small class="label" for="input">Email</small>
                                        <input type="email" class="form-control" name="email" value="<?php echo e(@$data['user']['email']); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group inner-label-holder"> <small class="label" for="input">Phone Number</small>
                                        <input type="text" class="form-control" name="phoneno" value="<?php echo e(@$data['user']['phone']); ?>" readonly>
                                    </div>
                                </div>
                                <?php } ?>
                                 <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group inner-label-holder"> <small class="label" for="input">Investor firm url</small>
                                        <input type="text" class="form-control" name="investorfirmUrl" value="<?php echo e($data['investorfirmUrl']); ?>" readonly>
                                    </div>
                                </div>
                                   <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group inner-label-holder"> <small class="label" for="input">Investor firm Fundraising URL</small>
                                        <input type="text" class="form-control" name="fundraisUrl" value="<?php echo e($data['fundraisUrl']); ?>" readonly>
                                    </div>
                                </div>
                                   <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group inner-label-holder"> <small class="label" for="input">Investor Firm Video</small>
                                        <input type="text" class="form-control" name="investorFirmvideo" value="<?php echo e(@$data['investorFirmvideo']); ?>" readonly>
                                    </div>
                                </div>
                                   <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group inner-label-holder"> 
                                        <small class="label" for="input">Slideshare URL</small>
                                        <input type="email" class="form-control" name="slideshareUrl" value="<?php echo e(@$data['slideshareUrl']); ?>" readonly>
                                    </div>
                                </div>
                        ...
                        <div class="card-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    ...
                                    <h6>
                                    <input type="text" class="form-control" name="firmTagline" value="<?php echo e(@$data['firmTagline']); ?>" readonly></h6>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    ...
                                    <p>Investor Firm Profile</p>
                                        ...
                                        <textarea class="form-control" placeholder="" rows="4" readonly><?php echo e(@$data['profileText']); ?></textarea>
                              ...
                              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                  <p>Short Investor Biography</p>
                                    <div class="form-group inner-label-holder textarea">
                                        ...
                                        <textarea class="form-control" placeholder="" rows="4" readonly><?php echo e(@$data['bioData']); ?></textarea>
                    ...
                    <div class="form-card">
                        ...
                        <div class="card-content">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <?php $invType = []; ?>
                                    <?php $__currentLoopData = $investorType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $in): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="form-group inner-label-holder" style="height: auto!important;"> 
                                        ...
                                        <div class="details-div"><?php echo e(implode(', ',$invType)); ?></div>
                                    </div>
                                 ...
                                 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                 <?php $invstment = []; ?>
                                    <?php $__currentLoopData = $investmentType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $in): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $invstment[]=  $in['typeInvestment']; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <div class="form-group inner-label-holder" style="height: auto!important;"> 
                                        <small class="label" for="input">Investment Type</small>
                                        <div class="details-div"><?php echo e(implode(', ',$invstment)); ?></div>
                                    </div>
                                ...
                                <?php  } ?>
                                 <div class="form-group inner-label-holder" style="height: auto!important;"> 
                                    ...
                                    <div class="details-div"><?php echo e(implode(', ',$secn)); ?></div>
                                </div>
                            ...
                            <div class="form-group inner-label-holder" style="height: auto!important;"> 
                                ...
                                <div class="form-group inner-label-holder" style="height: auto!important;"> 
                                    ...
                                    <div class="details-div"><?php echo e(implode(', ',$rf)); ?></div>
                                </div>
                                ...
                                <div class="form-group inner-label-holder" style="height: auto!important;"> 
                                    ...
                                    <div class="details-div"><?php echo e(implode(', ',$cn)); ?></div>
                                </div>
                                    ...
                                    <input type="text" class="form-control" name="assetUndermgmt" value="<?php echo e(@$data['assetUndermgmt']); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-group inner-label-holder"> <small class="label" for="input">Investment Range From $</small>
                                     <input type="text" class="form-control" name="assetUndermgmt" value="<?php echo e($data['investmentRangefrm']); ?>" readonly>
                                 </div>
                                </div>
                                     <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-group inner-label-holder"> <small class="label" for="input">Investment Range to $</small>
                                       <input type="text" class="form-control" name="assetUndermgmt" value="<?php echo e($data['investmentRangeto']); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-content social">
                            ...
                            <div class="row">
                              ...
                              <div class="input-group form-group inner-label-holder">
                                  ...
                                  <input type="text" class="form-control" name="linkedinUrl" aria-label="Username" aria-describedby="basic-addon1" value="<?php echo e(@$data['linkedinUrl']); ?>" readonly>
                                </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <div class="input-group form-group inner-label-holder">
                                  ...
                                  <input type="text" class="form-control" name="fbUrl" aria-label="Username" aria-describedby="basic-addon1" value="<?php echo e($data['fbUrl']); ?>" readonly>
                                </div>
                                </div>
                                     <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <div class="input-group form-group inner-label-holder">
                                  ...
                                  <input type="text" class="form-control" name="twitterUrl" aria-label="Username" aria-describedby="basic-addon1" value="<?php echo e(@$data['twitterUrl']); ?>" readonly>
                                </div>
                                </div>
  ...
  <div class="modal fade" id="requestModal3" role="dialog">
    <div class="modal-dialog">
    <?php echo e(Form::open(['class'=>'submitMessageReport','method'=>'post'])); ?>
...
<?php echo $__env->make('layouts.investor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/ec2-35-177-235-3.eu-west-2.compute.amazonaws.com/public_html/resources/views/frontend/investors-profile-view.blade.php ENDPATH**/ ?>