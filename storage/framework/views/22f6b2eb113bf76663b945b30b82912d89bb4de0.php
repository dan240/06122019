   ...
   <div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $("#home").click(function(){
                window.location.href = "<?php echo e(url('User/browse-investors')); ?>"
            });
            ...
            $("#editProfile").on('click',function(){
                window.location.href = "<?php echo e(url('User/editcompanyProfile')); ?>"
            });
            $("#viewProfile").on('click',function(){
                window.location.href = "<?php echo e(url('User/viewcompanyProfile')); ?>"
            });
    ...
    </script><?php /**PATH /home/admin/web/ec2-35-177-235-3.eu-west-2.compute.amazonaws.com/public_html/resources/views/frontend/include/user-header-investor.blade.php ENDPATH**/ ?>