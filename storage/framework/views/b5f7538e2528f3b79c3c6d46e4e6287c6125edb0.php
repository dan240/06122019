				...
				<div class="sidebar-menu">
					<ul id="SortConversation">
						...
						<li class="outbox_div " data-name="<?php echo time()- strtotime($lmsg['created_at']); ?>">
							<a href="javascript:;" data-user="<?php echo e($value['id']); ?>" class="MessageConversation">
								<?php 
								...
								?>
								<table cellspacing="0" cellpadding="0" border="0" class="messages <?php echo e(($unread==1 )? 'recent-mesg' : ''); ?>">
									<tbody>
										<tr>
											<td class="avatar">
												...
												?>
												<img class="view-message" rel="177391" src="<?php echo e($profileImg); ?>" alt="User">
											</td>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('.MessageConversation').on('click', function(){
				...
				$.ajax({
					method:"GET",
					url: "<?php echo e(url('GetMessageHistory/')); ?>/"+otherId,
					async:false,
			...
			$('body').on('click', '.signup_btn', function(e){
				...
				$.ajax({
					method:"POST",
					url: "<?php echo e(url('/User/postMsg')); ?>",
					async:false,
			...
			$('body').on('click', '#send', function(e){
				$(".se-pre-con").fadeIn("slow");
					...
					$.ajax({
						method:"POST",
						url: "<?php echo e(url('/User/sendUserMessage')); ?>",
						async:false,
		...
		function BindControls(){
	        $.ajax({
	            method:"POST",
	            url:"<?php echo e(url('User/findNamelist')); ?>",
...
<div class="new-message" style="display: none;">
    ...
    <div class="user-message-content">
        <?php echo e(Form::open(['class'=>'form chatNewBox','method'=>'post'])); ?>
...
<?php echo $__env->make('layouts.investor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/londcap-app.com/public_html/resources/views/frontend/MessageNew.blade.php ENDPATH**/ ?>