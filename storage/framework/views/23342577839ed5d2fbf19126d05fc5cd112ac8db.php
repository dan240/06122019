    ...
    <link href="<?php echo e(asset('admin/vendors/%40coreui/icons/css/coreui-icons.min.css')); ?>" rel="stylesheet">
    ...
    <link href="<?php echo e(asset('admin/css/style.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('admin/css/admin-custom.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('admin/vendors/pace-progress/css/pace.min.css')); ?>" rel="stylesheet">
...
<script src="https://cdn.datatables.net/1.10.19/js/jquery.dataTables.min.js"></script><?php /**PATH /home/admin/web/londcap-app.com/public_html/resources/views/backend/include/head.blade.php ENDPATH**/ ?>