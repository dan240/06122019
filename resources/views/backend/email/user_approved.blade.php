                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center"
                                        ...
                                        Your account has been approved.</td>
                                </tr>
                                <tr>
                                    <td>
                                        <!-- COPY -->
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td align="left"
                                                    ...
                                                    class="padding">
                                                    <p>Now you can login and explore the LondCap network.</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                                        ...
                                                        <tr>
                                                            <td align="center" style="border-radius: 0px;" bgcolor="#002060">
                                                                <a  href="https://londcap-app.com"
                                                                    ...
                                                                    class="mobile-button">Access Account</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
