...
<html lang="en">
  ...
  <body class="app flex-row align-items-center">
    <div class="container">
      {{Form::open(['class'=>'loginForm','method'=>'post'])}}
    ...
    <script src="{{ url('admin/vendors/jquery/js/jquery.min.js')}}"></script>
    <script src="{{ url('admin/vendors/popper.js/js/popper.min.js')}}"></script>
    <script src="{{ url('admin/vendors/bootstrap/js/bootstrap.min.js')}}"></script>
    <script src="{{ url('admin/vendors/pace-progress/js/pace.min.js')}}"></script>
    <script src="{{ url('admin/vendors/perfect-scrollbar/js/perfect-scrollbar.min.js')}}"></script>
