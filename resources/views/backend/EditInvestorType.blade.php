...
<div class="container-fluid">
	<div class="row" style="padding:10px;">
        <div class="col-md-6">
          <span style="font-size: 20px;">Investor Info</span>
        </div>
        ...
        <div class="col-md-6 text-right">
     	...
     	{{Form::open(['method'=>'post','class'=>'saveInvestorType'])}}
     	<div class="company-info">
			<div class="row">
	          	<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
	          		<label for="fname">Investor Type</label>
					<input type="text" id="typeInvestor" name="typeInvestor" value="{{@$data['typeInvestor']}}">
				</div>
...
<script>
	$(document).ready(function(){
		$('#save').on('click',function(e){
			...
			$.ajax({
				method:"POST",
				url:"{{ url('Admin/SaveInvestorType')}}",
				data:$('.saveInvestorType').serialize(),
