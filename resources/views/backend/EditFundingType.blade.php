...
<div class="container-fluid">
	<div class="row" style="padding:10px;">
        ...
        <div class="col-md-6 text-right">
     	...
     	{{Form::open(['method'=>'post','class'=>'saveFundingType'])}}
     	<div class="company-info">
			<div class="row">
	          	<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
	          		<label for="fname">Funding Type</label>
					<input type="text" id="fundingtype" name="fundingtype" value="{{@$data['typeFunding']}}">
				</div>
...
<script>
	$(document).ready(function(){
		$('#save').on('click',function(){
			$.ajax({
				method:"POST",
				url:"{{ url('Admin/SaveFundingType')}}",
				data:$('.saveFundingType').serialize(),
