                ...
                <tr>
                    <td align="center" valign="top" style="padding: 15px 0;background: #fff;" class="logo">
                        <a href="#" target="_blank">
                            <img alt="Logo" src="{{ asset('images/Logo_LondCap.png')}}" width="160" height="auto" style="display: block; font-family: Helvetica, Arial, sans-serif; color: #ffffff; font-size: 16px;" border="0">
                        </a>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                 <td align="center" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; color: #333333; padding-top: 30px; font-weight: 600">We recive a request to change your password.</td>
                            </tr>
                            <tr>
                                <td>
                                    <!-- COPY -->
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="left" style="font-size: 14px; font-family: Helvetica, Arial, sans-serif; color: #333333; padding-top: 30px;" class="padding"> <p>Hi {{@$userData['name']}},</p></td>
                                        </tr>
                                          <tr>
                                            ...
                                            <p>Use this link to setup a new password to your account. This link will expire in 4 hours.</p>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            <tr>
                                <td align="center">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="center" style="padding-top: 25px;padding-bottom: 25px;" class="padding">
                                                <table border="0" cellspacing="0" cellpadding="0" class="mobile-button-container">
                                                    <tr>
                                                        <td align="center" style="border-radius: 0px;" bgcolor="#002060"><a href="{{ url('User/resetPassword/').'/'.$userData['email']}}" target="_blank" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; border-radius: 3px; padding: 12px 30px; border: 1px solid #256F9C; display: inline-block;" class="mobile-button">Change Password</a></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left" style="padding: 0px 0 0 0; font-size: 14px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding">
                                            <p>If you didn't make this request, you do not to do anything.</p>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
