                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="left" style="font-size: 14px; font-family: Helvetica, Arial, sans-serif; color: #333333; padding-top: 30px;" class="padding"> <p>Hi Admin, </p></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <p>New Meeting. Please approve</p></td>
                                        </tr>
                                        <tr>
                                            <td align="left" style="padding: 0px 0 0 0; font-size: 14px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding">
                                            <p>{{ $sender['firstname'] }} {{ $sender['lastname'] }} has requested for meeting with {{ $reciver['firstname'] }} {{ $reciver['lastname'] }}.</p>
                                        ...
                                        <tr>
                                            <td align="center" style="padding-top: 25px;padding-bottom: 25px;" class="padding">
                                                <table border="0" cellspacing="0" cellpadding="0" class="mobile-button-container">
                                                    <tr>
                                                        <td align="center" style="border-radius: 0px;" bgcolor="#002060"><a href="#" target="_blank" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; border-radius: 3px; padding: 12px 30px; border: 1px solid #256F9C; display: inline-block;" class="mobile-button">Approve</a></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
