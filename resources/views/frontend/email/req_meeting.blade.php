                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="left"
                                                    ...
                                                    class="padding">
                                                    <p>Hi {{ $reciver['firstname'] }} {{ $reciver['lastname'] }}, </p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left"
                                                    ...
                                                    class="padding">
                                                    <p>You have a new meeting request from:</p>
                                                    
                                                    <p>
                                                        <span style="font-size: 16px; color: #0077b5;"> {{ $sender['firstname'] }} {{ $sender['lastname'] }}</span> - 
                                                        @isset($sender["investor_detail"])
                                                            <strong>{{ $sender["investor_detail"]["jobTitle"] }} at {{ $sender["investor_detail"]["firmName"] }}</strong>
                                                        @endisset
                                                        @isset($sender["company_detail"])
                                                            <strong>{{ $sender["company_detail"]["jobTitle"] }} at {{ $sender["company_detail"]["companyName"] }}</strong>
                                                        @endisset
                                                    </p>
                                                    
                                                    @isset($sender["investor_details"])
                                                    <p style="background-color: #F0F8FF; padding: 10px;">
                                                        <strong>Sector Focus</strong><br>
                                                        <span>{{ implode(', ', $sender["investor_details"]["sector_focus_details"]) }}</span><br>

                                                        <strong>Industry Focus</strong><br>
                                                        <span>{{ implode(', ', $sender["investor_details"]["industry_focus_details"]) }}</span><br>

                                                        <strong>Country Focus</strong><br>
                                                        <span>{{ implode(', ', $sender["investor_details"]["country_focus_details"]) }}</span><br>

                                                        <strong>Region Focus</strong><br>
                                                        <span>{{ implode(', ', $sender["investor_details"]["region_focus_details"]) }}</span>
                                                    </p>
                                                    @endisset

                                                    <p style="background-color: #F0F8FF; padding: 10px;">
                                                        <strong><?php print_r($message_contant); ?></strong>
                                                    </p>
                                                </td>    
                                            </tr>
                                        </table>
                                                    ...
                                                    <table border="0" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td align="center" style="border-radius: 0px;"
                                                                bgcolor="#002060"><a href="{{ url('/') }}" target="_blank"
                                                                    ...
                                                                    class="mobile-button">Reply</a></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="left"
                                                    style="padding: 0px 0 0 0; font-size: 14px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;"
                                                    class="padding">
                                                    <p style="margin-bottom: 0px">Thanks for you time,</p>
