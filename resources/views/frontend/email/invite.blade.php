                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center"
                                        ...
                                        Verify your email address to complete your registration.</td>
                                </tr>
                                <tr>
                                    <td>
                                        <!-- COPY -->
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td align="left"
                                                    style="padding: 0px 0 0 0; font-size: 14px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;"
                                                    class="padding">
                                                    <p>Thanks for signing up! We just need you to verify your email to complete setting up your account.</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                            ...
                                            <tr>
                                                <td align="center" style="padding-top: 25px;padding-bottom: 25px;" class="padding">
                                                    <table border="0" cellspacing="0" cellpadding="0" class="mobile-button-container">
                                                        <tr>
                                                            <td align="center" style="border-radius: 0px;" bgcolor="#002060">
                                                                <a  href="{{ $email_verification_link }}"
                                                                    ...
                                                                    class="mobile-button">Verify Email</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="left"
                                                    style="padding: 0px 0 0 0; font-size: 14px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;"
                                                    class="padding">
                                                    <p style="margin-bottom: 0px">Thank you for your time,</p>
                                                    <p style="margin-top: 0px; margin-bottom: 20px"> The LondCap Team.</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
