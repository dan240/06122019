                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <nav>
                        <ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="javascript:;" onclick="userInvestorIntrestedIn('{{$id}}')">Express Interested (Follower) </a></li>
                            <li class="breadcrumb-item active">Interested In (Following) {{count($compData)}}</li>
                        </ol>
                    </nav>
                </div>
            </div>
