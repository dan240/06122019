...
fieldset.scheduler-border {
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group inner-label-holder"> <small class="label" for="input">FIRST NAME </small>
                                        ...
                                        <input type="text" class="form-control" name="fname" value = "{{ @$data['user']['firstname']}}" readonly>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group inner-label-holder"> <small class="label" for="input">Last NAME</small>

                                        <input type="text" class="form-control"  name="lname" value="{{ @$data['user']['lastname']}}" readonly>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    ...
                    <div class="form-card">
                        ...
                        <div class="card-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <p>Company Tagline</p>
                                    <input type="text" class="form-control" value="{{ $data['companyTagline'] }}" readonly disabled />
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    ...
                                    <div class="form-group inner-label-holder textarea">
                                        ...
                                        <textarea class="form-control" style="resize:none" placeholder="" rows="4" readonly disabled>{{ @$data['profileText'] }}</textarea>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    ...
                                    <div class="form-group inner-label-holder textarea">
                                        ...
                                        <textarea class="form-control" style="resize:none" placeholder="" rows="4" readonly disabled>{{ @$data['personalBio'] }}</textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-group inner-label-holder" style="height: auto!important;"> 
                                        ...
                                        <div class="details-div">{{ implode(', ',$cmp) }}</div>
                                        </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    ...
                                    <div class="details-div">{{ implode(', ',$f_typ) }}</div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-group inner-label-holder" style="height: auto!important;"> 
                                       ...
                                       <?php $secType = explode(",",@$data['sector']); $sec = [];?>
                                        ...
                                        <div class="details-div">{{ implode(', ',$sec) }}</div>
                        ...
                        <div class="card-content social">
                            ...
                            <div class="row">
                              ...
                              <div class="input-group form-group inner-label-holder">
                                  ...
                                  <input type="text" class="form-control" placeholder="Enter link here" aria-label="Username" aria-describedby="basic-addon1" value="{{ @$data['fbUrl'] }}" readonly>
                                </div>
                                </div>
                       <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <div class="input-group form-group inner-label-holder">
 ...
 -------------->
  ...
  <div class="modal fade" id="requestModal2" role="dialog">
    ...
    <div class="modal-dialog">
    {{ Form::open(['class'=>'submitAbuse','method'=>'post'])}}
      <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header">
