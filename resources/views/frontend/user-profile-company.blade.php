                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:;" onclick="editCompanyProfile('{{$id}}')">Company Profile</a></li>
							 <li class="breadcrumb-item"><a href="#" onclick="userCompanyIntrestedIn('{{$id}}')">Expressed Interested (Follower) {{ app('App\Http\Controllers\UserController')->MeExpressedIn() }}</a></li>
                            <li class="breadcrumb-item active"> Interest In (Following) {{ app('App\Http\Controllers\UserController')->MeInterestedIn() }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
